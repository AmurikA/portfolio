...
const Navbar: React.FC = () => {
    return (
        ...
        <div className="flex justify-between items-center mx-auto py-10 px-5 ">
            ...
            {/*Mobile*/}
            <nav className=" hidden fixed left-0 top-0 bottom-0 h-full flex  w-full items-center justify-center bg-red-500  z-20 laptop:hidden">
                <ul className=" flex flex-col items-center gap-10 text-20px  text-white-dark  ">
                    <li><a href="" className="text-active font-bold">Logo</a></li>
                    <li><a href="" className="">About</a></li>
                    <li><a href="">Projects</a></li>
                    <li><a href="" className="">Contacts</a></li>
            ...
            {/*burger menu*/}
            <button id="burger" className="   group relative flex justify-center items-center h-5 w-[40px] z-50 laptop:hidden ">
                ...
                <span className="absolute left-0 bottom-0 h-[2px] w-full bg-white transition-transform group-[.active]:-translate-y-[9px] group-[.active]:-rotate-45"></span>
            </button>
        </div>
    );
};
