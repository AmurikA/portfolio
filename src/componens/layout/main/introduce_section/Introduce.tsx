...
const Introduce: React.FC = () => {
    return (
        <div className="container flex flex-col phoneLg:py-20 laptop:flex-row px-6 mx-auto  pb-32 gap-10 z-10">
            <div className="relative flex flex-col items-start gap-10 laptop:w-2/4    ">
                ...
                <div className="mx-auto flex flex-col items-center laptop:mx-0 laptop:items-start ">
                    ...
                    <h1 className={" font-bold text-white-dark text-20px phoneLg:text-36px laptop:text-28px"}>Kotasov
                                                                                                              Oleksandr</h1>
                </div>
                    ...
                    <ul className="flex gap-7">
                        <li>
                            <img src={InstagramLogoImg}
                                 alt="Instagram Logo"
                                 className="w-10 h-10 phoneLg:w-16 phoneLg:h-16 laptop:w-12 laptop:h-12"/>
                        </li>
                        <li>
                            <img src={GitLogoImg}
                                 alt="Git Logo"
                ...
                <div className="mx-auto text-center text-16px phoneLg:text-24px laptop:mx-0 laptop:text-start laptop:text-20px">
                    ...
                    ідеї на достойному рівні!
                </div>
                <div className={"items-center justify-center w-full mx-auto flex flex-col  tablet:flex-row laptop:mx-0 laptop:justify-start "}>
                    <div className="bg-orange-500 p-5 rounded-2xl text-white text-center text-14px  phoneLg:text-26px tablet:p-5 tablet:text-24px laptop:text-20px px-5">
                        Download CV
                    </div>
                    <div className="flex items-center my-3 tablet:ml-5">
                        ...
                        <h1 className={"text-gray-100 rounded-2xl text-center text-14px  phoneLg:text-20px tablet:text-20px"}>
                            Available for Hire
                        </h1>
                    </div>
                </div>
